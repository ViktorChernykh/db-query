	...
	struct Migrate: AsyncMigration {
		...
		func prepare(on db: Database) async throws {
			try await db.schema(v1.schema)
				...
				.field(v1.csrfExpires, .datetime, .required)
...
extension DBSessionModel {
	public enum v1 {
		...
		public static let csrfExpires = Column("csrfExpires", Self.alias)
...
extension DBSessionModel {
	...
	public func create(on db: SQLDatabase) async throws -> UUID {
		...
		let binds: [Encodable] = [id, string, csrf, csrfExpires, data, expires, userId]
